...
docs:
	@$(shell go env GOPATH)/bin/swag init --parseInternal  -g ../../../cmd/main.go --pd -d web/handlers/api,web/handlers/api_admin -exclude web/handlers/webui/ -o ./web/static/docs -ot json
