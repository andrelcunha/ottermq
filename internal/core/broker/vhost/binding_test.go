...
func TestDeleteBinding_AutoDeleteExchange(t *testing.T) {
	...
	// Delete binding
	err := vh.DeletBinding("ex1", "q1", "rk")
	if err != nil {
		t.Fatalf("DeletBinding failed: %v", err)
	}
...
func TestDeleteBinding_QueueNotFound(t *testing.T) {
	...
	err := vh.DeletBinding("ex3", "notfound", "rk")
	if err == nil {
...
func TestDeleteBinding_BindingNotFound(t *testing.T) {
	...
	err := vh.DeletBinding("ex4", "q4", "notfound")
	if err == nil {
